...
const baseURL = explicitApiUrl || (__DEV__
...
export function friendlyErrorMessage(error: unknown, fallback = "Ocorreu um erro.") {
  ...
  if (typeof status === "number") {
    switch (status) {
      ...
      case 500:
        return err?.response?.data?.detail || "O servidor retornou erro interno.";
      case 502:
      case 503:
      case 504:
